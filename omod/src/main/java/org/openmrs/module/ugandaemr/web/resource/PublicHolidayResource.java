...
public class PublicHolidayResource extends DelegatingCrudResource<PublicHoliday> {
    ...
    public PublicHoliday save(PublicHoliday publicHoliday) {
        return Context.getService(UgandaEMRService.class).savePublicHoliday(publicHoliday);
    }

    @Override
    public PublicHoliday getByUniqueId(String uniqueId) {
        PublicHoliday publicHoliday = Context.getService(UgandaEMRService.class).getPublicHolidaybyUuid(uniqueId);
        if (publicHoliday == null) {
            ...
            publicHoliday = Context.getService(UgandaEMRService.class).getPublicHolidayByDate(checkDate);
        }
	...
	public NeedsPaging<PublicHoliday> doGetAll(RequestContext context) throws ResponseException {
		return new NeedsPaging<PublicHoliday>(new ArrayList<PublicHoliday>(Context.getService(UgandaEMRService.class).getAllPublicHolidays()),
                context);
    }
    @Override
	...
	protected PageableResult doSearch(RequestContext context) {
        ...
        if (dateQuery != null) {
            ...
            publicHolidaysByQuery = Context.getService(UgandaEMRService.class).getPublicHolidaysByDate(checkDate);
