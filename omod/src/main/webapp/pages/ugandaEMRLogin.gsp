...
<div id="body-wrapper">
    ...
    <header id="header">
            ...
            <div class="row" id="header-image">
                <img  src="${ui.resourceLink("ugandaemr", "images/homepage.png")}"/>
    ...
    <div class="footer">
        <div class="center">
            Supported by <a href="http://www.mets.or.ug" target="_blank"
                                                            title="Makerere University School of Public Health METS Programme">MakSPH METS Programme</a>|  ${ui.message("ugandaemr.build.info")}
        </div>
        <div class="center">
