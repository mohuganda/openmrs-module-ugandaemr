<div class="info-section patientsummary">
    <div class="info-header">
        ...
        <h3>${ui.message("ugandaemr.patient.transfer.header")}</h3>
    ...
    <div class="info-body">
        ...
        <div>
            <strong>${ui.message("ugandaemr.patient.transfer.out.date")}:</strong>
            ${ui.format(dateTransferredOut)}
        </div>

        <div>
            <strong>${ui.message("ugandaemr.patient.transfer.out.location")}:</strong>
            ${transferredOutTo}
        </div>
    </div>
    <% } %>
    ...
    <div class="info-body" style="">
        ...
        <div>
            <strong>${ui.message("ugandaemr.patient.transfer.in.date")}:</strong>
            ${ui.format(dateTransferredIn)}
        </div>

        <div>
            <strong>${ui.message("ugandaemr.patient.transfer.in.location")}:</strong>
            ${transferredInTo}
        </div>
    </div>
    <% } %>
<% if(TransferHistory.size>0){%>
    ...
    <%} else{%>
    <div class="info-body">${ui.message("ugandaemr.patient.transfer.nodata")}</div>
    <%}%>
</div>