...
CREATE DEFINER=`root`@`localhost` PROCEDURE `generateARTRegister`(IN start_year INT(4),IN start_month INT(2))
  BEGIN
    ...
    insert into ugandaemr_art_register(patient_id,age,sex,art_start_date)
    ...
    -- Unique ID
    UPDATE ugandaemr_art_register AS t INNER JOIN (select pi.patient_id,pi.identifier from patient_identifier pi where pi.identifier_type = (select pit.patient_identifier_type_id from patient_identifier_type pit where pit.uuid = 'e1731641-30ab-102d-86b0-7a5022ba4115')) t1 ON t.patient_id = t1.patient_id SET unique_id = t1.identifier;
    -- Unique ID
    UPDATE ugandaemr_art_register AS t INNER JOIN (select pn.person_id,pn.family_name,pn.given_name from person_name pn) t1 ON t.patient_id = t1.person_id SET t.given_name = t1.given_name,t.surname = t1.family_name;

    UPDATE ugandaemr_art_register AS t INNER JOIN (select pd.person_id,pd.county_district,pd.address3,pd.address4,pd.address5 from person_address pd) t1 ON t.patient_id = t1.person_id SET t.district = t1.county_district,t.sub_county= t1.address3,t.village_cell= t1.address5;
    ...
    SET @transformed = CONCAT('select * from ugandaemr_art_register ar inner join (',SUBSTRING(sl_data, 1, CHAR_LENGTH(sl_data) - 1), ' from art_data group by person_id) d on(ar.patient_id = d.person_id)');
...
CREATE DEFINER=`openmrs`@`localhost` PROCEDURE `hmis105EID`(IN start_year int, IN start_month int)
  BEGIN
    ...
    DROP TABLE IF EXISTS ugandaemr_105_eid;

    CREATE TABLE IF NOT EXISTS ugandaemr_105_eid (
      patient_id INT,
      dob date,
      age INT,
      gender CHAR(1),
    ...
    insert into ugandaemr_105_eid(patient_id,dob,age,gender,date_enrolled)
      SELECT
        p.person_id,
        p.birthdate,
    ...
    UPDATE ugandaemr_105_eid AS t INNER JOIN (select o.person_id from obs o where o.concept_id = 99606 and YEAR(o.value_datetime) = start_year AND MONTH(o.value_datetime) = start_month group by o.person_id and o.voided = 0) t1 ON t.patient_id = t1.person_id SET first_pcr = 1;

    -- Second PCR Date during month and year
    UPDATE ugandaemr_105_eid AS t INNER JOIN (select o.person_id from obs o where o.concept_id = 99436 and YEAR(o.value_datetime) = start_year AND MONTH(o.value_datetime) = start_month group by o.person_id and o.voided = 0) t1 ON t.patient_id = t1.person_id SET second_pcr = 1;

    -- Age at first PCR
    UPDATE ugandaemr_105_eid AS t INNER JOIN (select o.person_id, MAX(o.value_datetime) as ag from obs o where o.concept_id = 99606 group by o.person_id and o.voided = 0) t1 ON t.patient_id = t1.person_id SET first_pcr_age = TIMESTAMPDIFF(MONTH, t.dob, t1.ag),first_pcr_test_date = t1.ag;

    -- Age at second PCR
    UPDATE ugandaemr_105_eid AS t INNER JOIN (select o.person_id, MAX(o.value_datetime) as ag from obs o where o.concept_id = 99436  group by o.person_id and o.voided = 0) t1 ON t.patient_id = t1.person_id SET second_pcr_age = TIMESTAMPDIFF(MONTH, t.dob,t1.ag), second_pcr_test_date = t1.ag;

    -- First PCR test results
    -- TODO fix the concept for when results are received
    UPDATE ugandaemr_105_eid AS t INNER JOIN (select o.person_id from obs o where o.concept_id = 99435 and YEAR(o.obs_datetime) = start_year AND MONTH(o.obs_datetime) = start_month group by o.person_id and o.voided = 0) t1 ON t.patient_id = t1.person_id SET first_pcr_test_results = 1;

    -- First PCR test results postive
    UPDATE ugandaemr_105_eid AS t INNER JOIN (select o.person_id from obs o where o.concept_id = 99435 and YEAR(o.obs_datetime) = start_year AND MONTH(o.obs_datetime) = start_month group by o.person_id and o.voided = 0 and o.value_coded = 703) t1 ON t.patient_id = t1.person_id SET first_pcr_test_results_positive = 1;


    -- Second PCR test results
    -- TODO fix the concept for when results are received
    UPDATE ugandaemr_105_eid AS t INNER JOIN (select o.person_id from obs o where o.concept_id = 99440 and YEAR(o.obs_datetime) = start_year AND MONTH(o.obs_datetime) = start_month group by o.person_id and o.voided = 0) t1 ON t.patient_id = t1.person_id SET second_pcr_test_results = 1;

    -- Second PCR test results postive
    UPDATE ugandaemr_105_eid AS t INNER JOIN (select o.person_id from obs o where o.concept_id = 99440 and YEAR(o.obs_datetime) = start_year AND MONTH(o.obs_datetime) = start_month group by o.person_id and o.voided = 0 and o.value_coded = 703) t1 ON t.patient_id = t1.person_id SET second_pcr_test_results_positive = 1;


    -- Fisrt PCR results give to care giver
    UPDATE ugandaemr_105_eid AS t INNER JOIN (select o.person_id,o.value_datetime from obs o where o.concept_id = 99438 and YEAR(o.value_datetime) = start_year AND MONTH(o.value_datetime) = start_month group by o.person_id and o.voided = 0) t1 ON t.patient_id = t1.person_id SET first_pcr_results_given_to_care_giver = 1,date_first_pcr_results_given_to_care_give = t1.value_datetime ;
    ...
    UPDATE ugandaemr_105_eid AS t INNER JOIN (select o.person_id from obs o where o.concept_id = 162879 and YEAR(o.value_datetime) = start_year AND MONTH(o.value_datetime) = start_month group by o.person_id and o.voided = 0) t1 ON t.patient_id = t1.person_id SET rapid_test_at_18_months = 1;

    -- Rapid test at 18 months  positive
    UPDATE ugandaemr_105_eid AS t INNER JOIN (select o.person_id from obs o where o.concept_id = 162880 and value_coded = 703 and YEAR(o.obs_datetime) = start_year AND MONTH(o.obs_datetime) = start_month group by o.person_id and o.voided = 0) t1 ON t.patient_id = t1.person_id SET rapid_test_at_18_months_positive = 1;

    -- EID enrolled into care
    UPDATE ugandaemr_105_eid AS t INNER JOIN (select o.person_id from obs o where o.concept_id = 163004 and value_coded = 1065 and YEAR(o.obs_datetime) = start_year AND MONTH(o.obs_datetime) = start_month group by o.person_id and o.voided = 0) t1 ON t.patient_id = t1.person_id SET on_care = 1;
    ...
    SELECT
      (SELECT COUNT(*) FROM ugandaemr_105_eid where first_pcr = 1 and first_pcr_age <= 18) AS '1PCR',
      (SELECT COUNT(*) FROM ugandaemr_105_eid where second_pcr = 1 and second_pcr_age <= 18) AS '2PCR',
      (SELECT COUNT(*) FROM ugandaemr_105_eid where (first_pcr = 1 OR second_pcr = 1) and (first_pcr_age < 2 or second_pcr_age < 2)) AS '<2 months',
      (SELECT COUNT(*) FROM ugandaemr_105_eid where first_pcr_test_results = 1) AS '1PCRResults',
      (SELECT COUNT(*) FROM ugandaemr_105_eid where first_pcr_test_results = 1 and first_pcr_test_results_positive = 1) AS '1PCRResults+',
      (SELECT COUNT(*) FROM ugandaemr_105_eid where second_pcr_test_results = 1) AS '2PCRResults',
      (SELECT COUNT(*) FROM ugandaemr_105_eid where second_pcr_test_results = 1 and second_pcr_test_results_positive = 1) AS '2PCRResults+',
      (SELECT COUNT(*) FROM ugandaemr_105_eid where first_pcr = 1 OR second_pcr = 1) AS 'PCRResults',
      (SELECT COUNT(*) FROM ugandaemr_105_eid where (first_pcr = 1 OR second_pcr = 1) and (DATEDIFF(first_pcr_test_date, date_first_pcr_results_given_to_care_give) <= 14 OR DATEDIFF(second_pcr_test_date, date_second_pcr_results_given_to_care_give) <= 14)) AS 'Within two weeks',
      (SELECT COUNT(*) FROM ugandaemr_105_eid where first_pcr_results_given_to_care_giver = 1) AS 'Given to Caregiver',
      (SELECT COUNT(*) FROM ugandaemr_105_eid where rapid_test_at_18_months = 1) AS 'rapidtest',
      (SELECT COUNT(*) FROM ugandaemr_105_eid where rapid_test_at_18_months_positive = 1) AS 'rapidtestresult',
      (SELECT COUNT(*) FROM ugandaemr_105_eid where on_care = 1) AS 'oncare',
      (SELECT COUNT(*) FROM ugandaemr_105_eid where started_on_cpt = 1) AS 'oncpt',
      (SELECT COUNT(*) FROM ugandaemr_105_eid where started_on_cpt_within_2_months = 1) AS 'oncptwithin2months';
...
CREATE DEFINER=`openmrs`@`localhost` PROCEDURE `hmis106a1a`(IN start_year INT, IN start_quarter INT)
  BEGIN
    ...
    DROP TABLE IF EXISTS ugandaemr_106a1a;

    CREATE TABLE IF NOT EXISTS ugandaemr_106a1a (
      patient_id INT,
      age INT,
      gender CHAR(1),
      date_enrolled DATE,
    ...
    insert into ugandaemr_106a1a(patient_id,age,gender,date_enrolled) SELECT
                                                                    p.person_id,
    ...
    UPDATE ugandaemr_106a1a AS t INNER JOIN (select e.patient_id from encounter e where e.encounter_datetime <= (MAKEDATE(start_year, 1) + INTERVAL start_quarter - 1 QUARTER - INTERVAL 1 DAY) and e.voided = 0 group by patient_id) t1 ON t.patient_id = t1.patient_id SET visit_before_qurater = 1;

    -- Had first encounter this quarter
    UPDATE ugandaemr_106a1a AS t INNER JOIN (select e.patient_id from encounter e where YEAR(e.encounter_datetime) = start_year AND QUARTER(e.encounter_datetime) = start_quarter and e.voided = 0 and e.patient_id not in (select ei.patient_id from encounter ei where ei.encounter_datetime <= (MAKEDATE(start_year, 1) + INTERVAL start_quarter - 1 QUARTER - INTERVAL 1 DAY) ) group by patient_id) t1 ON t.patient_id = t1.patient_id SET first_visit_in_qurater = 1;

    -- Get the last visit for patient in the quarter
    UPDATE ugandaemr_106a1a AS t INNER JOIN (select patient_id from encounter where YEAR(encounter_datetime) = start_year AND QUARTER(encounter_datetime) = start_quarter and voided = 0 group by patient_id) t1 ON t.patient_id = t1.patient_id SET visited_in_quarter = 1;

    -- Update the column for pregnant and lactating mothers
    UPDATE ugandaemr_106a1a AS t INNER JOIN (select person_id from obs where concept_id = 90200 and value_coded = 90012 and YEAR(obs_datetime) = start_year and QUARTER(obs_datetime) = start_quarter and voided = 0 group by person_id) t1 ON t.patient_id = t1.person_id SET preg_and_lactating = 1;

    -- Update the column for started INH this quarter
    UPDATE ugandaemr_106a1a AS t INNER JOIN (select person_id from obs where concept_id = 99604 and value_numeric > 0 and YEAR(obs_datetime) = start_year and QUARTER(obs_datetime) = start_quarter and voided = 0 group by person_id having count(*) BETWEEN 1 AND 3) t1 ON t.patient_id = t1.person_id SET started_inh = 1;

    -- Update the column transfered from another facility
    UPDATE ugandaemr_106a1a AS t INNER JOIN (select person_id from obs where concept_id = 99110 and value_coded = 90003 and YEAR(obs_datetime) = start_year and QUARTER(obs_datetime) = start_quarter and voided = 0 group by person_id having count(*) BETWEEN 1 AND 3) t1 ON t.patient_id = t1.person_id SET transfer_in = 1;

    -- Update the column transfered from another facility while on art
    UPDATE ugandaemr_106a1a AS t INNER JOIN (select person_id from obs where concept_id = 99064 and value_coded > 0 and YEAR(obs_datetime) = start_year and QUARTER(obs_datetime) = start_quarter and voided = 0 group by person_id having count(*) BETWEEN 1 AND 3) t1 ON t.patient_id = t1.person_id SET transfer_in_on_art = 1;
    ...
    UPDATE ugandaemr_106a1a AS t INNER JOIN (select person_id from obs where concept_id = 99037 and value_numeric > 0 and YEAR(obs_datetime) = start_year and QUARTER(obs_datetime) = start_quarter AND voided = 0 group by person_id) t1 ON t.patient_id = t1.person_id SET on_cpt = 1;

    -- Update the column for patients who were assessed for TB
    UPDATE ugandaemr_106a1a AS t INNER JOIN (select person_id from obs where concept_id = 90216 and value_coded > 0 and YEAR(obs_datetime) = start_year and QUARTER(obs_datetime) = start_quarter AND voided = 0 group by person_id) t1 ON t.patient_id = t1.person_id SET assessed_for_tb = 1;

    -- Update the column for patients who were diagnosed  for TB
    UPDATE ugandaemr_106a1a AS t INNER JOIN (select person_id from obs where concept_id = 90216 and value_coded = 90078 and YEAR(obs_datetime) = start_year and QUARTER(obs_datetime) = start_quarter AND voided = 0 group by person_id) t1 ON t.patient_id = t1.person_id SET diagnosed_with_tb = 1;

    -- Update the column for patients started on TB treatement
    UPDATE ugandaemr_106a1a AS t INNER JOIN (select person_id from obs where concept_id = 90216 and value_coded = 90071 and YEAR(obs_datetime) = start_year and QUARTER(obs_datetime) = start_quarter AND voided = 0 group by person_id) t1 ON t.patient_id = t1.person_id SET started_tb_rx = 1;
    ...
    UPDATE ugandaemr_106a1a AS t INNER JOIN (select person_id from obs where concept_id = 90299 and value_datetime <= (MAKEDATE(start_year, 1) + INTERVAL start_quarter QUARTER - INTERVAL 1 DAY)  group by person_id) t1 ON t.patient_id = t1.person_id SET eligible_and_ready = 1;

    -- ART section

    -- Pregnant during quarter
    UPDATE ugandaemr_106a1a AS t INNER JOIN (select person_id from obs where concept_id = 90041  and value_coded = 1065 and YEAR(obs_datetime) = start_year and QUARTER(obs_datetime) = start_quarter group by person_id) t1 ON t.patient_id = t1.person_id SET preg_during_quarter = 1;

    -- Update the column for those started art based on pregnancy
    UPDATE ugandaemr_106a1a AS t INNER JOIN (select person_id from obs where concept_id = 99602  and value_numeric = 1 and YEAR(obs_datetime) = start_year and QUARTER(obs_datetime) = start_quarter group by person_id) t1 ON t.patient_id = t1.person_id SET art_based_on_preg = 1;


    -- Update the column for those started art based on cd4
    UPDATE ugandaemr_106a1a AS t INNER JOIN (select person_id from obs where concept_id = 99082  and value_numeric > 0 and YEAR(obs_datetime) = start_year and QUARTER(obs_datetime) = start_quarter group by person_id) t1 ON t.patient_id = t1.person_id SET art_based_on_cd4 = 1;
    ...
    UPDATE ugandaemr_106a1a AS t INNER JOIN (select person_id from obs where concept_id = 162990 AND value_coded in(162986,90002,162987) and YEAR(obs_datetime) = start_year and QUARTER(obs_datetime) = start_quarter AND voided = 0 group by person_id) t1 ON t.patient_id = t1.person_id SET third_line = 1;

    -- Patients with good adherence
    UPDATE ugandaemr_106a1a AS t INNER JOIN (select person_id from obs where concept_id = 90221 AND value_coded = 90156 and YEAR(obs_datetime) = start_year and QUARTER(obs_datetime) = start_quarter AND voided = 0 group by person_id) t1 ON t.patient_id = t1.person_id SET good_adherence = 1;
      ...
      (SELECT
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                    ...
                    FROM
                      ugandaemr_106a1a where visit_before_qurater = 1 and transfer_in = 0) Enrollment USING (indicator_id)) ind1
      LEFT JOIN
      (SELECT
         indicator_id,
         q2indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where first_visit_in_qurater = 1 and transfer_in = 0) Enrollment USING (indicator_id)) ind2 ON (ind1.indicator_id = ind2.indicator_id)
      LEFT JOIN
      (SELECT
         indicator_id,
         q3indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where first_visit_in_qurater = 1 and preg_and_lactating = 1 and transfer_in = 0) Enrollment USING (indicator_id)
      ...
      (SELECT
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where first_visit_in_qurater = 1 and started_inh = 1 and transfer_in = 0) Enrollment USING (indicator_id)) ind4 ON (ind3.indicator_id = ind4.indicator_id)
      LEFT JOIN
      (SELECT
         indicator_id,
         q5indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where transfer_in = 0 and (visited_in_quarter = 1 or visit_before_qurater = 1)) Enrollment USING (indicator_id)) ind5 ON (ind4.indicator_id = ind5.indicator_id)
      LEFT JOIN
      (SELECT
         indicator_id,
         q6indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where transfer_in = 1) Enrollment USING (indicator_id)) ind6 ON (ind5.indicator_id = ind6.indicator_id)
      LEFT JOIN
      (SELECT
         indicator_id,
         q7indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where visited_in_quarter = 1 and on_art_this_quarter = 0 and on_art_before_this_quarter = 0) enrollment USING (indicator_id)) ind7 ON (ind6.indicator_id = ind7.indicator_id)
      LEFT JOIN
      (SELECT
         indicator_id,
         q8indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where visited_in_quarter = 1 and on_art_this_quarter = 0 and on_cpt = 1 and on_art_before_this_quarter = 0) enrollment USING (indicator_id)) ind8 ON (ind7.indicator_id = ind8.indicator_id)
      LEFT JOIN
      (SELECT
         indicator_id,
         q9indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where visited_in_quarter = 1 and on_art_this_quarter = 0 and assessed_for_tb = 1 and on_art_before_this_quarter = 0) enrollment USING (indicator_id)) ind9 ON (ind8.indicator_id = ind9.indicator_id)
      LEFT JOIN
      (SELECT
         indicator_id,
         q10indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where visited_in_quarter = 1 and on_art_this_quarter = 0 and diagnosed_with_tb = 1 and on_art_before_this_quarter = 0) enrollment USING (indicator_id)) ind10 ON (ind9.indicator_id = ind10.indicator_id)
      LEFT JOIN
      (SELECT
         indicator_id,
         q11indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where visited_in_quarter = 1 and on_art_this_quarter = 0 and started_tb_rx = 1 and on_art_before_this_quarter = 0) enrollment USING (indicator_id)) ind11 ON (ind10.indicator_id = ind11.indicator_id)
      LEFT JOIN
      (SELECT
         indicator_id,
         q12indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where visited_in_quarter = 1 and on_art_this_quarter = 0 and assessed_for_malnutrition = 1 and on_art_before_this_quarter = 0) enrollment USING (indicator_id)) ind12 ON (ind11.indicator_id = ind12.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q13indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where visited_in_quarter = 1 and on_art_this_quarter = 0 and malnourished = 1 and on_art_before_this_quarter = 0) enrollment USING (indicator_id)) ind13 ON (ind12.indicator_id = ind13.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q14indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where visited_in_quarter = 1 and on_art_this_quarter = 0 and eligible_and_ready = 1 and on_art_before_this_quarter = 0) enrollment USING (indicator_id)) ind14 ON (ind13.indicator_id = ind14.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q15indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where on_art_before_this_quarter = 1) enrollment USING (indicator_id)) ind15 ON (ind14.indicator_id = ind15.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q16indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where on_art_this_quarter = 1 and on_art_before_this_quarter = 0 and transfer_in_on_art = 0) enrollment USING (indicator_id)) ind16 ON (ind15.indicator_id = ind16.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q17indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where on_art_this_quarter = 1 and on_art_before_this_quarter = 0 and art_based_on_cd4 = 1 and transfer_in_on_art = 0) enrollment USING (indicator_id)) ind17 ON (ind16.indicator_id = ind17.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q18indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where on_art_this_quarter = 1 and on_art_before_this_quarter = 0 and (art_based_on_preg = 1 or preg_during_quarter = 1) and transfer_in_on_art = 0) enrollment USING (indicator_id)) ind18 ON (ind17.indicator_id = ind18.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q19indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where (on_art_this_quarter = 1 or on_art_before_this_quarter = 1) and transfer_in_on_art = 0) enrollment USING (indicator_id)) ind19 ON (ind18.indicator_id = ind19.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q20indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where on_art_this_quarter = 1 and (first_line_child = 1 or first_line_adult = 1)) enrollment USING (indicator_id)) ind20 ON (ind19.indicator_id = ind20.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q21indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where on_art_this_quarter = 1 and (second_line_child = 1 or second_line_adult = 1)) enrollment USING (indicator_id)) ind21 ON (ind20.indicator_id = ind21.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q22indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where third_line = 1 and on_art_this_quarter = 1) enrollment USING (indicator_id)) ind22 ON (ind21.indicator_id = ind22.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q23indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where on_art_this_quarter = 1 and on_cpt = 1) enrollment USING (indicator_id)) ind23 ON (ind22.indicator_id = ind23.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q24indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where on_art_this_quarter = 1 and assessed_for_tb = 1) enrollment USING (indicator_id)) ind24 ON (ind23.indicator_id = ind24.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q25indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where on_art_this_quarter = 1 and diagnosed_with_tb = 1) enrollment USING (indicator_id)) ind25 ON (ind24.indicator_id = ind25.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q26indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where started_tb_rx = 1 and on_art_this_quarter = 1 and first_visit_in_qurater = 1) enrollment USING (indicator_id)) ind26 ON (ind25.indicator_id = ind26.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q27indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where started_tb_rx = 1 and on_art_this_quarter = 1) enrollment USING (indicator_id)) ind27 ON (ind26.indicator_id = ind27.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q28indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where good_adherence = 1 and on_art_this_quarter = 1) enrollment USING (indicator_id)) ind28 ON (ind27.indicator_id = ind28.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q29indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where assessed_for_malnutrition = 1 and on_art_this_quarter = 1) enrollment USING (indicator_id)) ind29 ON (ind28.indicator_id = ind29.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q30indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where malnourished = 1 and on_art_this_quarter = 1) enrollment USING (indicator_id)) ind30 ON (ind29.indicator_id = ind30.indicator_id);
...
CREATE DEFINER=`openmrs`@`localhost` PROCEDURE `hmis106a1aYouth`(IN start_year INTEGER, IN start_quarter INTEGER)
  BEGIN
    ...
    -- Update the column for those started art based on cd4
    UPDATE ugandaemr_106a1a AS t INNER JOIN (select person_id from obs where concept_id = 99602  and value_coded = 1 and YEAR(obs_datetime) = start_year and QUARTER(obs_datetime) = start_quarter group by person_id) t1 ON t.patient_id = t1.person_id SET art_based_on_preg = 1;
      ...
      (SELECT
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where first_visit_in_qurater = 0) Enrollment USING (indicator_id)) ind1
      LEFT JOIN
      (SELECT
         indicator_id,
         q2indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where first_visit_in_qurater = 1) Enrollment USING (indicator_id)) ind2 ON (ind1.indicator_id = ind2.indicator_id)
      LEFT JOIN
      (SELECT
         indicator_id,
         q3indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where first_visit_in_qurater = 1 and preg_and_lactating = 1) Enrollment USING (indicator_id)
       GROUP BY q3indicator) ind3 ON (ind2.indicator_id = ind3.indicator_id)
      LEFT JOIN
      (SELECT
         indicator_id,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where first_visit_in_qurater = 1 and started_inh = 1) Enrollment USING (indicator_id)) ind4 ON (ind3.indicator_id = ind4.indicator_id)
      LEFT JOIN
      (SELECT
         indicator_id,
         q5indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a) Enrollment USING (indicator_id)) ind5 ON (ind4.indicator_id = ind5.indicator_id)
      LEFT JOIN
      (SELECT
         indicator_id,
         q6indicator,
      ...
      (SELECT
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where visited_in_quarter = 1 and on_art_this_quarter = 0) enrollment USING (indicator_id)) ind7 ON (ind6.indicator_id = ind7.indicator_id)
      LEFT JOIN
      (SELECT
         indicator_id,
         q8indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where visited_in_quarter = 1 and on_art_this_quarter = 0 and on_cpt = 1) enrollment USING (indicator_id)) ind8 ON (ind7.indicator_id = ind8.indicator_id)
      LEFT JOIN
      (SELECT
         indicator_id,
         q9indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where visited_in_quarter = 1 and on_art_this_quarter = 0 and assessed_for_tb = 1) enrollment USING (indicator_id)) ind9 ON (ind8.indicator_id = ind9.indicator_id)
      LEFT JOIN
      (SELECT
         indicator_id,
         q10indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where visited_in_quarter = 1 and on_art_this_quarter = 0 and diagnosed_with_tb = 1) enrollment USING (indicator_id)) ind10 ON (ind9.indicator_id = ind10.indicator_id)
      LEFT JOIN
      (SELECT
         indicator_id,
         q11indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where visited_in_quarter = 1 and on_art_this_quarter = 0 and started_tb_rx = 1) enrollment USING (indicator_id)) ind11 ON (ind10.indicator_id = ind11.indicator_id)
      LEFT JOIN
      (SELECT
         indicator_id,
         q12indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where visited_in_quarter = 1 and on_art_this_quarter = 0 and assessed_for_malnutrition = 1) enrollment USING (indicator_id)) ind12 ON (ind11.indicator_id = ind12.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q13indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where visited_in_quarter = 1 and on_art_this_quarter = 0 and malnourished = 1) enrollment USING (indicator_id)) ind13 ON (ind12.indicator_id = ind13.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q14indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where visited_in_quarter = 1 and on_art_this_quarter = 0 and eligible_and_ready = 1) enrollment USING (indicator_id)) ind14 ON (ind13.indicator_id = ind14.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q15indicator,
      ...
      (SELECT
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where on_art_this_quarter = 1 and first_visit_in_qurater = 1 and art_based_on_cd4 = 1) enrollment USING (indicator_id)) ind17 ON (ind16.indicator_id = ind17.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q18indicator,
       ...
       FROM
         ...
         LEFT JOIN (SELECT
                      1 AS indicator_id, gender, age
                    FROM
                      ugandaemr_106a1a where on_art_this_quarter = 1 and first_visit_in_qurater = 1 and art_based_on_preg = 1) enrollment USING (indicator_id)) ind18 ON (ind17.indicator_id = ind18.indicator_id)
      INNER JOIN
      (SELECT
         indicator_id,
         q19indicator,
